...
(defparameter *default-config*
  (list :server-url "https://rappyruns-production.up.railway.app"
        ...
        :pinshare-allowed nil ; cached /api/me "features" verdict for the Pin Share rollout: shows the Settings group on the first frame (refreshed by CHECK-TOKEN and the half-hourly permission refresher; without it the relay never runs, whatever :pinshare-enabled says)
